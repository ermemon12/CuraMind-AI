...
export default function Landing() {
  return (
    <div className="flex flex-col min-h-screen bg-gray-50 font-sans">
      ...
      {/* Hero Section */}
      <header className="flex flex-col md:flex-row items-center justify-between px-8 md:px-20 py-16 bg-gradient-to-r from-blue-50 to-teal-50">
        <div className="max-w-lg mb-10 md:mb-0 animate-fadeInUp">
